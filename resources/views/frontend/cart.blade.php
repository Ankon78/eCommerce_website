                                    ...
                                    @if (session('cart'))
                                        ...
                                        @php
                                            ...
                                            <tr>
                                                ...
                                                <td class="remove-col">
                                                    <button class="btn-remove" onclick="removeCart(this, {{ $id }})"><i class="icon-close"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <aside class="col-lg-3">
                            <div class="summary summary-cart">
                                ...
                                <form action="/pay" method="POST">
                                    ...
                                    @csrf
                                    <button type="submit" class="btn btn-outline-primary-2 btn-order btn-block">Pay Now</button>
                                </form>
